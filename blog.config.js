...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'HI,这里是doing软件分享的博客，你一定可以在这里找到你需要的软件！',
  ...
  IMAGE_COMPRESS_WIDTH: process.env.NEXT_PUBLIC_IMAGE_COMPRESS_WIDTH || 700, // 图片压缩宽度默认值，作用于博客封面和文章内容 越小加载图片越快
